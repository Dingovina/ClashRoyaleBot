...
class TrainingRoiTests(unittest.TestCase):
    ...
    def test_elixir_crop_requires_fullscreen_input(self) -> None:
        layout = self.layout
        ...
        with self.assertRaises(ValueError):
            pil_rgb_elixir_number(already, layout)

    def test_battlefield_crop_requires_fullscreen_input(self) -> None:
        layout = self.layout
        ...
        with self.assertRaises(ValueError):
            pil_rgb_masked_bottom_panel(already, layout)
